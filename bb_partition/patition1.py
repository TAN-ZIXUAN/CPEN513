    ...
    if node_to_assign == None:
        ...
        if tmp_cutsize < min_cutsize:
            ...
            if check_partition(curr_assignment, 0):
                ...
                if (cal_net_cutsize(tmp_assignment) < best_cutsize - 1):
                    recursive_bb_partition(tmp_assignment, next_node, best_cutsize - 1)
...
if __name__ == "__main__":
    ...
    node_to_assign = 0
    best_cutsize = num_nets // 2 # initial min_cutsize
